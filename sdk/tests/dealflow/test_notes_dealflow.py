...
def test_PipedriveContact_model_update():
    person: PipedriveDealflowNote = PipedriveDealflowNote(id=1)
...
def test_PipedriveContact_model_get():
    note: PipedriveDealflowNote = PipedriveDealflowNote(id=1)
    response = note.get(person_id=331)
...
def test_PipedriveContact_model_create():
    ...
    person: PipedriveDealflowNote = PipedriveDealflowNote(**data)
...
def test_PipedriveContact_model_delete():
    note: PipedriveDealflowNote = PipedriveDealflowNote(id=17)
